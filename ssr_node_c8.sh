...
cd /tmp && git clone https://github.com/teolinkiat/shadowsocks-mod.git
...
do_service(){
	...
	wget --no-check-certificate -O ssr_node.service https://raw.githubusercontent.com/teolinkiat/Airport-toolkit/master/ssr_node.service.el8
